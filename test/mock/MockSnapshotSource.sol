...
/// @dev Allows setting voting power for specific accounts and blocks
contract MockSnapshotSource is SnapshotInterface {
    ...
    /// @notice Mapping from account to block number to prior votes
    ...
    /// @notice Set the prior votes for an account at a specific block
    /// @param account The account to set votes for
