...
contract DeployxWellLiveSystemMoonbeamTest is xwellDeployMoonbeam {
    ...
    function testBridgeInSuccess(uint256 mintAmount) public {
        ...
        assertEq(endingXWellBalance, startingXWellBalance, "user xWELL balance incorrect, should not change");
        assertEq(startingWellBalance + mintAmount, endingWellBalance, "user WELL balance incorrect, did not increase");
        assertEq(endingXWellTotalSupply, startingXWellTotalSupply, "total xWELL supply incorrect, should not change");
