...
contract ERC4626EthDeployIntegrationTest is Test {
    ...
    function testSweepFailsMToken() public {
        address[] memory tokens = new address[](1);
        tokens[0] = addresses.getAddress("MOONWELL_WETH");
    ...
    function testSweepSucceedsAsRewardRecipient() public {
        ...
        vm.prank(rewardRecipient);
        vault.sweepRewards(tokens);
        assertEq(weth.balanceOf(vault.rewardRecipient()), mintAmount);
    }
    ...
    function testSetMarketSupplyCaps() public {
        ...
        mTokens[0] = MToken(addresses.getAddress("MOONWELL_WETH"));
    ...
    function testRedeemZeroFails() public {
