...
/// @title MIP-X47: MultichainGovernorV2 Migration to Ethereum Mainnet
...
contract mipx47 is HybridProposal {
    ...
    constructor() {
        bytes memory proposalDescription = abi.encodePacked(
            vm.readFile("./proposals/mips/mip-x47/x47.md")
        );
    ...
    function afterDeploy(Addresses addresses, address) public override {
        ...
        // NOTE: We add 1 because this proposal (mip-x47) will become proposal N+1 on Moonbeam,
    ...
    function build(Addresses addresses) public override {
        ...
        // This proposal (mip-x47) is executed by the old Moonbeam MultichainGovernor, so it cannot
