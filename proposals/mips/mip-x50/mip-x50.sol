...
/// @title MIP-X50: Upgrade xWELL WormholeBridgeAdapter to Executor framework
...
contract mipx50 is HybridProposal {
    using ProposalActions for *;
    using ChainIds for uint256;

    string public constant override name = "MIP-X50";

    constructor() {
        bytes memory proposalDescription = abi.encodePacked(
            vm.readFile("./proposals/mips/mip-x50/x50.md")
        );
