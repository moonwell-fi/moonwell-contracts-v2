...
/// @title MIP-X51B
/// @notice Base-only rewards distribution plus the 4 bad-debt repayments that
///         originally shipped in mip-x51. Split from x51 so the propose() tx
///         fits under Moonbeam's effective per-extrinsic gas ceiling.
///         Moonbeam + Optimism reward updates live in mip-x51a.
