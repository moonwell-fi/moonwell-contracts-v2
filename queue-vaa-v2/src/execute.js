...
// Block explorer URL
const blockExplorer = network === 'moonbase' ? 'https://sepolia.basescan.org/tx/' : 'https://basescan.org/tx/';
...
class MoonwellEvent {
    ...
    discordMessagePayload(color, resultText, txURL, networkName, sequence, timestamp) {
        const friendlyNetworkName = networkName === 'moonbase' ? 'Base Sepolia' : 'Base';
