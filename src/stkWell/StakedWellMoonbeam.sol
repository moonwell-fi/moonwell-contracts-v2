 ...
 * @dev Moonbeam implementation of StakedTokenV2, upgraded to use timestamps for snapshots in place of block numbers
 * @author Moonwell
 **/
contract StakedWellMoonbeam is StakedTokenV2 {
