...
library AddressName {
    string constant governor = "TEMPORAL_GOVERNOR";
    string constant timelock = "MOONBEAM_TIMELOCK";
    string constant unitroller = "UNITROLLER";
    string constant wormholeCore = "WORMHOLE_CORE";
    string constant chainlinkOracle = "CHAINLINK_ORACLE";
    string constant comptroller = "COMPTROLLER";
