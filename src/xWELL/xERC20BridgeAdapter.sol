...
abstract contract xERC20BridgeAdapter is Ownable2StepUpgradeable {
    ...
    function _bridgeIn(uint256 chainId, address user, uint256 amount) internal virtual {
    ...
    function _bridgeOut(address user, uint256 dstChainId, uint256 amount, address to) internal virtual;
}
