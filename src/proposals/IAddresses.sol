...
interface IAddresses {
    ...
    function addAddressEOA(string memory name, address addr, uint256 chainId) external;

    /// @notice add an address for a specific chainId
    function addAddress(string memory name, address addr, uint256 _chainId, bool isContract) external;
    ...
    function changeAddress(string memory name, address _addr, uint256 _chainId, bool isContract) external;
