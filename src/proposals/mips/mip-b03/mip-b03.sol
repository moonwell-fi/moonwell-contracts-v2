...
contract mip03 is HybridProposal, Configs {
    ...
    constructor() {
        ...
        string memory descriptionPath = vm.envOr("LISTING_PATH", string("./src/proposals/mips/mip-b03/mip-b03.md"));
    ...
    function build(Addresses addresses) public override {
        ...
        {
            string memory mtokensPath = vm.envOr("MTOKENS_PATH", string("./src/proposals/mips/mip-b03/MTokens.json"));
...

        {
            string memory mtokensPath =
                vm.envOr("EMISSION_PATH", string("./src/proposals/mips/mip-b03/RewardStreams.json"));
            string memory fileContents = vm.readFile(mtokensPath);
            bytes memory rawJson = vm.parseJson(fileContents);
