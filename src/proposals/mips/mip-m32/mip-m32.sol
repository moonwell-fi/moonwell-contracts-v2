...
contract mipm32 is Configs, HybridProposal, ParameterValidation {
    ...
    constructor() {
        bytes memory proposalDescription = abi.encodePacked(vm.readFile("./src/proposals/mips/mip-m32/MIP-M32.md"));
    ...
    function run(Addresses addresses, address) public override {
        ...
        require(actions.proposalActionTypeCount(ActionType.Base) == 0, "MIP-M31: should have no base actions");

        require(actions.proposalActionTypeCount(ActionType.Moonbeam) == 3, "MIP-M31: should have 3 moonbeam actions");
    ...
    function validate(Addresses addresses, address) public view override {
        ...
        assertEq(Timelock(addresses.getAddress("MOONWELL_mWBTC")).admin(), governor, "MOONWELL_mWBTC admin incorrect");
