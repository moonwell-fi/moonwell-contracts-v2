...
contract mipb15 is Proposal, CrossChainProposal, Configs {
    /// @notice the name of the proposal
    string public constant name = "MIP WBTC Market Creation";
    ...
    constructor() {
        ...
        string
            memory descriptionPath = "./src/proposals/mips/mip-b15/MarketListingDescription.md";
        ...
        {
            string
                memory mtokensPath = "./src/proposals/mips/mip-b15/MTokens.json";
        ...
        {
            string
                memory mtokensPath = "./src/proposals/mips/mip-b15/RewardStreams.json";
            string memory fileContents = vm.readFile(mtokensPath);
            bytes memory rawJson = vm.parseJson(fileContents);
