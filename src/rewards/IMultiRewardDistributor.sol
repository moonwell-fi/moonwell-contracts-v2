...
interface IMultiRewardDistributor is MultiRewardDistributorCommon {
    ...
    function _updateSupplySpeed(MToken _mToken, address _emissionToken, uint256 _newSupplySpeed) external;
    function _updateBorrowSpeed(MToken _mToken, address _emissionToken, uint256 _newBorrowSpeed) external;
    function _updateOwner(MToken _mToken, address _emissionToken, address _newOwner) external;
    function _updateEndTime(MToken _mToken, address _emissionToken, uint256 _newEndTime) external;
}
